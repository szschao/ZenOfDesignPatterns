...
class Client {
    ...
    public static Branch compositeCorpTree(){
        ...
        Branch financeDep = new Branch("赵三驼子","财务部门经理",20000);
        //再把三个 小组长生产出来
        Branch firstDevGroup = new Branch("杨三也谢","开发一组组长",50000);
        Branch secondDevGroup = new Branch("吴大棒锥","开发二组组长",50000);
        //把所有小兵都产生出来
